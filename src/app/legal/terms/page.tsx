        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Unless otherwise stated, Ulisha Store and/or its licensors own
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                You must be at least 18 years of age to use this website. You
                must provide true, accurate, current, and complete information
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                reserve the right at any time to modify or discontinue any
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                transfers, and cryptocurrencies. All payments must be received
                in full before products are shipped.
              </p>
              <p className="text-gray-600">
                Shipping times may vary depending on the delivery location and
                product availability. We are not responsible for delays caused
                by customs or other factors beyond our control.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                We reserve the right to modify or terminate the affiliate
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                In no event shall Ulisha Store be liable for any direct,
