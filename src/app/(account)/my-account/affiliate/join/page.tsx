...
const App = () => {
  ...
  const benefits = [
    { text: "Earn up to 15% commission on every sale.", icon: faDollarSign },
    {
      text: "Get access to marketing materials and dedicated support.",
      icon: faAward,
    },
    {
      text: "Track your clicks, conversions, and earnings in real-time.",
      icon: faCheckCircle,
    },
  ];
        ...
        <div className="relative p-8 sm:p-12 bg-gradient-to-br from-orange-400 to-orange-600 text-white flex flex-col justify-center">
          <div className="relative z-10">
            ...
            <p className="text-sm sm:text-base mb-8 opacity-90">
              Join our growing community of content creators and influencers.
              It&apos;s simple to get started and a great way to monetize your
              platform.
            </p>
